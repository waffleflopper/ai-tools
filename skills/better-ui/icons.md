...
When a swap benefits from animation, reuse the project's transition or consult the optional [icon-transition recipes](icon-transitions.md). An immediate state change is also valid.
