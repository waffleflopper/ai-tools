...
Once the prototype has answered its question, capture the answer, then capture the prototype the way the [SKILL](SKILL.md) describes. When implementation is authorized, the validated reducer / machine / function set can inform the real module; retain the TUI and prototype in the agreed location as evidence of the decision.
